...
config = {
  ...
  "PreciceAdapter": {        # precice adapter for bottom tendon
    ...
    "DynamicHyperelasticitySolver": {
      ...
      "snesMaxIterations":          10,     #auf 10                      # maximum number of iterations in the nonlinear solver, nicht gleich in settings_muscle_contraction.py
      "snesRelativeTolerance":      1e-5,     #auf siehe variables.py                    # relative tolerance of the nonlinear solver, nicht gleich in settings_muscle_contraction.py
