...
class RangeOfMotionPlotter():
    def __init__(self, initial_muscle_lengths, range_of_motions):
        self._stretched_muscle_lengths = initial_muscle_lengths
        self._range_of_motions = range_of_motions

    def save_as_csv(self):
        range_of_motions = self._range_of_motions.flatten()
        stretched_muscle_length_one = self._stretched_muscle_lengths[:, 0]
        stretched_muscle_length_two = self._stretched_muscle_lengths[:, 1]
    ...
    def plot(self, title):
        ...
        x = self._stretched_muscle_lengths[:, 0]
        y = self._stretched_muscle_lengths[:, 1]
